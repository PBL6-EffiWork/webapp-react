...
function Boards() {
  ...
  const [boards, setBoards] = useState<{ _id: string; title: string; description: string }[]>([])
      ...
      <Box sx={{ paddingX: 2, my: 4 }}>
        <Grid container spacing={2}>
          ...
          <Grid xs={12} sm={9}>
            ...
            {boards?.length === 0 &&
              <Typography component="span" sx={{ fontWeight: 'bold', mb: 3 }}>No result found!</Typography>
            }
