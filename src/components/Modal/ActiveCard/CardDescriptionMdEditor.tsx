...
interface CardDescriptionMdEditorProps {
  cardDescriptionProp: string | undefined;
  handleUpdateCardDescription: (description: string | undefined) => void;
}

function CardDescriptionMdEditor({ cardDescriptionProp, handleUpdateCardDescription }: CardDescriptionMdEditorProps) {
