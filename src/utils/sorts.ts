/**
 * Created by effiwork.com's author on March 28, 2021
 * Updated by effiwork.com's author on Jun 28, 2023
 * ---
...
export const mapOrder = (originalArray: any[], orderArray: any[], key: string): any[] => {
